...
//	E_fsconfig(fsfd, FSCONFIG_SET_STRING, "timeo", "600", 0);
//	E_fsconfig(fsfd, FSCONFIG_SET_STRING, "retrans", "2", 0);
	E_fsconfig(fsfd, FSCONFIG_SET_STRING, "addr", "169.254.200.1", 0);
	E_fsconfig(fsfd, FSCONFIG_SET_STRING, "source", "169.254.200.1:/", 0);
	E_fsconfig(fsfd, FSCONFIG_SET_STRING, "clientaddr", "169.254.200.2", 0);
...
//	E_fsconfig(fsfd, FSCONFIG_SET_STRING, "fsc", "d85f8159aec7", 0);
	...
	E(move_mount(mfd, "", AT_FDCWD, "/mnt/foo", MOVE_MOUNT_F_EMPTY_PATH));
	E(close(mfd));
	return 0;
}
